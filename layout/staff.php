...
?>
	<div class="row banner">
	  ...
	  <div class="col-lg-4  float_right" id="mrs_s">
		  <img class="img-circle" id="mrs_s_img" src="../dist/img/team/head-shots/mrs.JPG" alt="140x140">
		  <h2>Mrs. Scaccabarrozzi<br><small>Office Manager</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->

	  <div class="col-lg-4 float_left" id="n1">
		  <img class="img-circle" id="n1_img" src="../dist/img/team/head-shots/n1.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p class="p1left">Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->

	  <div class="col-lg-4  float_right" id="n2">
		  <img class="img-circle" id="n2_img" src="../dist/img/team/head-shots/n2.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->	

	  <div class="col-lg-4 float_left" id="n3">
		  <img class="img-circle" id="n3_img" src="../dist/img/team/head-shots/n3.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p class="p1left">Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->

	  <div class="col-lg-4  float_right" id="n4">
		  <img class="img-circle" id="n4_img" img src="../dist/img/team/head-shots/n4.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->
  	</div>
