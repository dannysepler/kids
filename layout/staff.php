...
?>
	<div class="row tour">
  	...
  	<div class="row team">
		  ...
		  <img class="img-circle" img src="../dist/img/team/head-shots/dr.jpg" alt="140x140">
	  ...
	  <div class="col-lg-4" id="mrs_s">
		  <img class="img-circle" img src="../dist/img/team/head-shots/mrs.JPG" alt="140x140">
	...
	<div class="col-lg-4" id="nurse">
		  <img class="img-circle" img src="../dist/img/team/head-shots/n1.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->
	<div class="col-lg-4" id="nurse">
		  <img class="img-circle" img src="../dist/img/team/head-shots/n2.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->	
	<div class="col-lg-4" id="nurse">
		  <img class="img-circle" img src="../dist/img/team/head-shots/n3.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->
	<div class="col-lg-4" id="nurse">
		  <img class="img-circle" img src="../dist/img/team/head-shots/n4.jpg" alt="140x140">
		  <h2>Nurse Name<br><small>Registered Nurse</small></h2>
		  <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
	  </div><!-- /.col-lg-4 -->
  	</div>
